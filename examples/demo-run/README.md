...
to see how an architect model, a builder, the repo, and the human interact on a
single slice.

| Step | File | What it shows |
| --- | --- | --- |
| 0 | [`before.md`](before.md) | Repo state before the slice |
| 1 | [`architect-spec.md`](architect-spec.md) | Architect model's output + builder block |
| 2 | [`builder-output.md`](builder-output.md) | Builder PHASE 0-5 run |
| 3 | [`review-verdict.md`](review-verdict.md) | Architect judging raw evidence |
